...
function my_script_init()
{
	...
	wp_enqueue_script( 'gsapScrollTrriger', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.9.1/ScrollTrigger.min.js', array('gsap'), '3.9.1', true );

	wp_enqueue_script( 'gsap_js', get_template_directory_uri() . '/assets/js/gsap.js', array( 'gsapScrollTrriger' ), '1.0.0' , true);
